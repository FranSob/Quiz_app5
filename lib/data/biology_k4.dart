...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_eksp_5', question: 'Wzmacniacze (enhancery) to sekwencje:', options: ['Kodujące białka', 'Regulatorowe, zwiększające intensywność transkrypcji', 'Kończące translację', 'Występujące wyłącznie w mRNA'], correctIndex: 1, explanation: 'Wzmacniacze wiążą czynniki transkrypcyjne i mogą leżeć daleko od genu.'),
          QuizQuestion(id: 'q_k4_eksp_6', question: 'Operon to:', options: ['Pojedynczy intron', 'Zespół genów prokariotycznych przepisywanych razem i wspólnie regulowanych', 'Enzym syntetyzujący RNA', 'Fragment rybosomu'], correctIndex: 1, explanation: 'Geny operonu dają jedną cząsteczkę mRNA.'),
          ...
          QuizQuestion(id: 'q_k4_eksp_8', question: 'Sekwencja mRNA AUG UUU UAA koduje:', options: ['Trzy aminokwasy', 'Dwa aminokwasy (metioninę i fenyloalaninę), po czym translacja się kończy', 'Jeden aminokwas', 'Żadnego aminokwasu'], correctIndex: 1, explanation: 'UUU koduje fenyloalaninę, a UAA jest kodonem stop.'),
        ],
      ),
      Topic(
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_eksp_14', question: 'Acetylacja histonów:', options: ['Wycisza geny', 'Rozluźnia chromatynę i ułatwia transkrypcję', 'Wycina introny', 'Kończy translację'], correctIndex: 1, explanation: 'Rozluźniona chromatyna jest dostępna dla polimerazy RNA.'),
          QuizQuestion(id: 'q_k4_eksp_15', question: 'Aktywna insulina powstaje z dłuższego prekursora w wyniku:', options: ['Alternatywnego splicingu', 'Przycinania łańcucha — modyfikacji potranslacyjnej', 'Odwrotnej transkrypcji', 'Replikacji DNA'], correctIndex: 1, explanation: 'Z prekursora wycinany jest fragment łańcucha.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_zm_9', question: 'Białko p53 w komórce z uszkodzonym DNA:', options: ['Przyspiesza podziały', 'Zatrzymuje cykl komórkowy i kieruje komórkę do naprawy lub apoptozy', 'Wycina introny', 'Wytwarza przeciwciała'], correctIndex: 1, explanation: 'Gen TP53 jest genem supresorowym.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_zm_20', question: 'Aneuploidie powstają najczęściej wskutek:', options: ['Crossing-over', 'Nieprawidłowego rozejścia się chromosomów w mejozie', 'Mutacji cichej', 'Odwrotnej transkrypcji'], correctIndex: 1, explanation: 'Gameta otrzymuje wtedy o jeden chromosom za dużo lub za mało.'),
        ],
      ),
    ],
  ),
...
''',
        ...
        questions: [
          QuizQuestion(id: 'q_k4_bio_10', question: 'Ludzką insulinę produkuje się obecnie głównie za pomocą:', options: ['Trzustek zwierząt', 'Zmodyfikowanych genetycznie bakterii lub drożdży', 'Roślin strączkowych', 'Krwi pępowinowej'], correctIndex: 1, explanation: 'Mikroorganizmy z wprowadzonym ludzkim genem wytwarzają ją w dużych ilościach.'),
          ...
          QuizQuestion(id: 'q_k4_bio_17', question: 'Komórki iPS uzyskuje się:', options: ['Z wczesnych zarodków', 'Przez przeprogramowanie komórek somatycznych', 'Z krwi pępowinowej', 'Z komórek bakterii'], correctIndex: 1, explanation: 'Dlatego nie wymagają niszczenia zarodków.'),
          QuizQuestion(id: 'q_k4_bio_18', question: 'Wskazaniem do skorzystania z poradnictwa genetycznego jest:', options: ['Przeziębienie', 'Mukowiscydoza u rodzeństwa jednego z partnerów planujących dziecko', 'Złamanie kości', 'Niedobór witaminy C'], correctIndex: 1, explanation: 'Partner może być nosicielem choroby genetycznej.'),
        ],
      ),
    ],
  ),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_ew_18', question: 'Pula genowa to:', options: ['Zestaw genów jednego osobnika', 'Zbiór wszystkich alleli wszystkich osobników populacji', 'Liczba osobników w populacji', 'Zestaw chromosomów gamety'], correctIndex: 1, explanation: 'Ewolucja zmienia właśnie skład puli genowej.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_eko_15', question: 'Zagęszczenie populacji to:', options: ['Liczba osobników w populacji', 'Liczba osobników na jednostkę powierzchni lub objętości', 'Stosunek samic do samców', 'Liczba urodzeń w ciągu roku'], correctIndex: 1, explanation: 'Liczebność to całkowita liczba osobników.'),
        ],
      ),
      Topic(
...
ENDEMITY I RELIKTY
Endemity to gatunki występujące wyłącznie na określonym, zwykle niewielkim obszarze. Powstają najczęściej w wyniku długotrwałej izolacji geograficznej — dlatego szczególnie wiele endemitów występuje na wyspach, np. na Madagaskarze (lemury), w Australii (większość torbaczy) czy na Wyspach Galapagos, oraz w wysokich górach i w starych, izolowanych jeziorach, np. w Bajkale. W Polsce endemitami są m.in. warzucha polska w Pieninach i przytulia krakowska. Relikty to gatunki, które przetrwały na danym obszarze z dawnych epok, gdy panowały tam inne warunki — np. relikty glacjalne, takie jak brzoza karłowata, przetrwały w Polsce od epoki lodowcowej na torfowiskach i w górach.

GORĄCE PUNKTY RÓŻNORODNOŚCI
Gorące punkty różnorodności biologicznej (hotspoty) to obszary o wyjątkowo dużej liczbie gatunków, w tym gatunków endemicznych, które jednocześnie są silnie zagrożone działalnością człowieka i utraciły już dużą część pierwotnej roślinności. Należą do nich m.in. Madagaskar, basen Morza Śródziemnego, Andy tropikalne, lasy atlantyckie Brazylii i Filipiny, a w morzach — rafy koralowe. Zajmują niewielką część powierzchni lądów, a żyje w nich znaczna część wszystkich gatunków roślin i kręgowców, dlatego ich ochrona pozwala zachować dużą część różnorodności biologicznej Ziemi przy stosunkowo niewielkich nakładach.
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_roz_2', question: 'Największą różnorodnością gatunkową charakteryzuje się:', options: ['Tundra', 'Tajga', 'Wilgotny las równikowy', 'Pustynia'], correctIndex: 2, explanation: 'Sprzyjają temu wysoka temperatura i wilgotność przez cały rok.'),
...
Ochrona przyrody może być ścisła — polegająca na całkowitym powstrzymaniu się od ingerencji człowieka, by procesy przyrodnicze przebiegały naturalnie — lub czynna, polegająca na zabiegach ochronnych, np. koszeniu łąk, usuwaniu krzewów czy gatunków inwazyjnych, gdy bez nich ekosystem lub gatunek by zanikł. Ochrona może dotyczyć miejsca występowania gatunku (ochrona in situ) lub odbywać się poza nim, np. w ogrodach zoologicznych i bankach genów (ochrona ex situ). Ustawa o ochronie przyrody wymienia formy ochrony obszarowej i indywidualnej. Park narodowy to obszar o powierzchni powyżej 1000 ha, wyróżniający się szczególnymi wartościami przyrodniczymi, na którym ochronie podlega cała przyroda. Rezerwat przyrody obejmuje obszar zachowany w stanie naturalnym lub mało zmienionym, z cennymi ekosystemami, siedliskami lub gatunkami. Park krajobrazowy chroni wartości przyrodnicze, historyczne i kulturowe, a gospodarka jest w nim dozwolona w ograniczonym zakresie. Obszar chronionego krajobrazu chroni wyróżniające się krajobrazy i pełni funkcję korytarzy ekologicznych. Obszary Natura 2000 to europejska sieć obszarów chroniących najcenniejsze siedliska przyrodnicze oraz gatunki zagrożone w skali Unii Europejskiej; obejmują obszary specjalnej ochrony ptaków i specjalne obszary ochrony siedlisk. Do form ochrony indywidualnej należą pomniki przyrody (np. stare drzewa, głazy narzutowe), stanowiska dokumentacyjne, użytki ekologiczne i zespoły przyrodniczo-krajobrazowe. Ochrona gatunkowa obejmuje gatunki roślin, zwierząt i grzybów zagrożone wyginięciem — ścisłą lub częściową. Informacje o zagrożonych gatunkach zawierają czerwone listy i czerwone księgi.
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k4_roz_13', question: 'Obszary Natura 2000 tworzone są w celu ochrony:', options: ['Zabytków architektury', 'Najcenniejszych siedlisk i gatunków w skali UE', 'Wyłącznie lasów', 'Terenów rekreacyjnych'], correctIndex: 1, explanation: 'Obejmują obszary specjalnej ochrony ptaków i siedlisk.'),
          ...
          QuizQuestion(id: 'q_k4_roz_16', question: 'Park narodowy w Polsce musi mieć powierzchnię powyżej:', options: ['100 ha', '1000 ha', '10 000 ha', '50 ha'], correctIndex: 1, explanation: 'Tak określa ustawa o ochronie przyrody.'),
        ],
      ),
    ],
  ),
