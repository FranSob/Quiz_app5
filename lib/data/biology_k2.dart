...
Archeowce są odrębną domeną organizmów. Ich ściana komórkowa nie zawiera mureiny, a lipidy błonowe mają rozgałęzione łańcuchy połączone wiązaniami eterowymi (u bakterii — estrowymi), co zwiększa odporność na warunki skrajne. Aparat transkrypcji i translacji archeowców bardziej przypomina eukariotyczny niż bakteryjny. Wiele archeowców to ekstremofile — termofile żyjące w gorących źródłach i halofile w środowiskach silnie zasolonych. Inną ważną grupą są metanogeny: bezwzględne beztlenowce wytwarzające metan, żyjące na bagnach, w osadach dennych i w przewodzie pokarmowym przeżuwaczy.

ZNACZENIE ARCHEOWCÓW
Metanogeny uczestniczą w obiegu węgla i wykorzystuje się je w biogazowniach oraz oczyszczalniach ścieków, gdzie wytwarzany przez nie metan służy jako paliwo. Ten sam proces zachodzący w przewodzie pokarmowym przeżuwaczy i na polach ryżowych jest jednak ważnym źródłem metanu — gazu cieplarnianego. Archeowce ze środowisk skrajnych są źródłem enzymów odpornych na wysoką temperaturę, stosowanych w biotechnologii, na przykład termostabilnych polimeraz DNA wykorzystywanych w metodzie PCR. Część archeowców utlenia amoniak, uczestnicząc w obiegu azotu w oceanach i glebie. Nie są znane archeowce chorobotwórcze dla człowieka.
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_bakt_6', front: 'Wymień trzy ważne grupy archeowców i miejsca ich występowania.', back: 'Termofile (gorące źródła), halofile (środowiska silnie zasolone) i metanogeny (bagna, przewód pokarmowy przeżuwaczy — wytwarzają metan).'),
          Flashcard(id: 'f_k2_bakt_20', front: 'Jakie znaczenie mają archeowce dla człowieka?', back: 'Metanogeny wytwarzają biogaz w biogazowniach i oczyszczalniach, ale też metan cieplarniany; z archeowców pochodzą termostabilne enzymy, np. polimerazy DNA do PCR. Nie znamy archeowców chorobotwórczych dla człowieka.'),
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_bakt_6', question: 'Laseczkami nazywamy bakterie, które:', options: ['Mają kształt kulisty i tworzą długie łańcuszki', 'Są spiralnie skręcone i poruszają się dzięki wiciom', 'Mają kształt wydłużony i wytwarzają przetrwalniki', 'Mają kształt lekko wygięty, podobny do przecinka'], correctIndex: 2, explanation: 'Laseczki to pałeczkowate bakterie wytwarzające przetrwalniki, np. laseczka tężca.'),
          QuizQuestion(id: 'q_k2_bakt_7', question: 'Otoczka śluzowa bakterii pełni funkcję:', options: ['Ruchową, umożliwiającą aktywne pływanie', 'Ochronną przed wysychaniem i fagocytozą', 'Magazynującą dodatkowe cząsteczki DNA', 'Fotosyntetyczną, dzięki zawartym barwnikom'], correctIndex: 1, explanation: 'Otoczka chroni bakterię przed wysychaniem i utrudnia jej pochłonięcie przez komórki żerne.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_bakt_16', question: 'Przetrwalniki bakterii są odporne przede wszystkim na:', options: ['Antybiotyki, ale nie na wysoką temperaturę', 'Wysoką temperaturę, wysychanie i środki chemiczne', 'Wyłącznie na działanie promieniowania świetlnego', 'Niskie pH, ale nie na brak wody w otoczeniu'], correctIndex: 1, explanation: 'Silnie odwodniona cytoplazma i grube osłony chronią przetrwalnik przed skrajnymi warunkami.'),
        ],
      ),
    ],
  ),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_grz_8', question: 'Rdze i głownie to grzyby:', options: ['Saprotroficzne, rozkładające martwe drewno', 'Pasożytnicze, powodujące straty w uprawach', 'Symbiotyczne, tworzące mikoryzę z drzewami', 'Jadalne, uprawiane na skalę przemysłową'], correctIndex: 1, explanation: 'To pasożyty roślin wywołujące choroby zbóż i innych upraw.'),
        ],
      ),
      Topic(
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_grz_13', question: 'Najskuteczniejszą profilaktyką grzybicy stóp jest:', options: ['Noszenie szczelnego gumowego obuwia przez cały dzień', 'Osuszanie skóry między palcami i klapki w miejscach publicznych', 'Profilaktyczne przyjmowanie antybiotyków przed wyjściem na basen', 'Korzystanie ze wspólnych ręczników w przebieralniach'], correctIndex: 1, explanation: 'Wilgoć sprzyja grzybicy, a klapki ograniczają kontakt z zakażonym podłożem.'),
          QuizQuestion(id: 'q_k2_grz_14', question: 'Grzybice narządów płciowych wywołują najczęściej:', options: ['Pędzlaki z rodzaju Penicillium', 'Drożdżaki z rodzaju Candida', 'Grzyby wywołujące rdzę zbóż', 'Workowce z rodzaju smardz'], correctIndex: 1, explanation: 'Za większość takich zakażeń odpowiadają drożdżaki Candida.'),
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_prot_9', front: 'Wymień trzy grupy glonów zaliczanych do protistów.', back: 'Okrzemki, brunatnice i bruzdnice (a także eugleniny).'),
        ],
        questions: [
...
ZNACZENIE PROTISTÓW
Glony planktonowe stanowią podstawę łańcuchów pokarmowych w wodach i odpowiadają za znaczną część produkcji tlenu na Ziemi. Pancerzyki okrzemek tworzą złoża ziemi okrzemkowej, wykorzystywanej jako materiał ścierny, filtracyjny i izolacyjny. Z brunatnic pozyskuje się alginiany, stosowane jako zagęstniki w przemyśle spożywczym, kosmetycznym i farmaceutycznym. Nadmiar substancji odżywczych w wodzie prowadzi do zakwitów glonów i bruzdnic, po których rozkład masy glonów zużywa tlen i powoduje śnięcie organizmów wodnych.

PROTISTY SYMBIOTYCZNE
Wiele protistów żyje w symbiozie z innymi organizmami. Wiciowce zamieszkujące jelito termitów trawią celulozę z drewna, którym żywią się te owady — bez nich termity nie mogłyby korzystać z takiego pokarmu. Orzęski w żwaczu przeżuwaczy uczestniczą w rozkładzie pokarmu roślinnego. Bruzdnice żyjące w tkankach koralowców dostarczają im produktów fotosyntezy, a w zamian otrzymują schronienie i związki mineralne; utrata tych symbiontów prowadzi do blaknięcia i obumierania raf koralowych.

FAZY JĄDROWE I TYPY CYKLI ROZWOJOWYCH
W cyklu rozwojowym organizmów rozmnażających się płciowo występują na przemian dwie fazy jądrowe: haplofaza, w której komórki mają pojedynczy zestaw chromosomów (n), i diplofaza, w której mają zestaw podwójny (2n). Haplofaza przechodzi w diplofazę w wyniku zapłodnienia, a diplofaza w haplofazę w wyniku mejozy, dlatego o typie cyklu decyduje moment, w którym zachodzi mejoza. W cyklu z mejozą zygotyczną jedynym stadium diploidalnym jest zygota, która od razu dzieli się mejotycznie, a organizm dorosły jest haploidalny — tak przebiega cykl zarodźca malarii, którego zygota powstaje w przewodzie pokarmowym komara. W cyklu z mejozą gametyczną organizm dorosły jest diploidalny, a haploidalne są wyłącznie gamety — tak jest u okrzemek. W cyklu z mejozą sporyczną występuje przemiana pokoleń: diploidalny sporofit wytwarza w wyniku mejozy haploidalne zarodniki, z których rozwija się haploidalny gametofit wytwarzający gamety — taki cykl ma wiele brunatnic, np. listownica.
''',
        flashcards: [
          Flashcard(id: 'f_k2_prot_20', front: 'Czym różni się haplofaza od diplofazy?', back: 'W haplofazie komórki mają pojedynczy zestaw chromosomów (n), w diplofazie — podwójny (2n).'),
          Flashcard(id: 'f_k2_prot_21', front: 'Jakie procesy przeprowadzają jedną fazę jądrową w drugą?', back: 'Zapłodnienie zmienia haplofazę w diplofazę, a mejoza — diplofazę w haplofazę.'),
          Flashcard(id: 'f_k2_prot_22', front: 'Na czym polega cykl z mejozą zygotyczną? Podaj przykład.', back: 'Jedynym stadium diploidalnym jest zygota, która od razu przechodzi mejozę, a dorosły organizm jest haploidalny — np. zarodziec malarii.'),
          Flashcard(id: 'f_k2_prot_23', front: 'Na czym polega cykl z mejozą gametyczną? Podaj przykład.', back: 'Dorosły organizm jest diploidalny, a haploidalne są tylko gamety — np. okrzemki.'),
          Flashcard(id: 'f_k2_prot_24', front: 'Na czym polega cykl z mejozą sporyczną? Podaj przykład.', back: 'Występuje przemiana pokoleń: sporofit (2n) wytwarza przez mejozę zarodniki, z których rozwija się gametofit (n) — np. listownica.'),
          Flashcard(id: 'f_k2_prot_25', front: 'Podaj przykłady protistów symbiotycznych.', back: 'Wiciowce w jelicie termitów trawiące celulozę, orzęski w żwaczu przeżuwaczy, bruzdnice w tkankach koralowców.'),
          ...
          Flashcard(id: 'f_k2_prot_17', front: 'Do czego wykorzystuje się alginiany i skąd pochodzą?', back: 'Z brunatnic; służą jako zagęstniki w przemyśle spożywczym, kosmetycznym i farmaceutycznym.'),
        ...
        questions: [
          QuizQuestion(id: 'q_k2_prot_9', question: 'Wektorem zarodźca malarii jest:', options: ['Samica kleszcza pospolitego', 'Samica komara widliszka', 'Samiec komara widliszka', 'Pchła szczurza'], correctIndex: 1, explanation: 'Zarodziec przenoszony jest przez samice komara z rodzaju Anopheles.'),
          ...
          QuizQuestion(id: 'q_k2_prot_15', question: 'Alginiany stosowane jako zagęstniki pozyskuje się z:', options: ['Okrzemek', 'Brunatnic', 'Euglen', 'Śluzowców'], correctIndex: 1, explanation: 'Alginiany to polisacharydy ścian komórkowych brunatnic.'),
...
ZNACZENIE GLONÓW
Glony morskie i słodkowodne są producentami — stanowią podstawę łańcuchów pokarmowych w wodach i odpowiadają za znaczną część produkcji tlenu na Ziemi. Z krasnorostów pozyskuje się agar, wykorzystywany jako podłoże w hodowlach mikrobiologicznych oraz jako zagęstnik w przemyśle spożywczym. Niektóre gatunki, na przykład krasnorost porfira (nori) i zielenica ulwa, są spożywane przez człowieka. Glony bywają też stosowane jako nawozy oraz jako źródło substancji dla przemysłu kosmetycznego.
''',
        flashcards: [
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_ros_2', question: 'Krasnorosty mogą żyć głębiej niż inne glony, ponieważ:', options: ['Nie potrzebują światła, bo odżywiają się cudzożywnie', 'Fikoerytryna pochłania światło niebieskozielone, docierające najgłębiej', 'Chlorofil b pochłania światło czerwone, docierające najgłębiej', 'Grube ściany komórkowe chronią je przed wysokim ciśnieniem wody'], correctIndex: 1, explanation: 'Barwnik dodatkowy pozwala wykorzystać światło o krótkiej fali, przenikające głęboko w wodzie.'),
...
RODZIMI PRZEDSTAWICIELE GRUP ROŚLIN
Do mchów należą m.in. płonnik pospolity i torfowce, do widłakowych — widłak goździsty, do skrzypowych — skrzyp polny, do paprociowych — nerecznica samcza i orlica pospolita, do nagonasiennych — sosna zwyczajna, jodła pospolita, modrzew europejski i jałowiec pospolity, a do okrytonasiennych — m.in. dąb szypułkowy, buk zwyczajny, mniszek lekarski i trawy. Aby zaliczyć roślinę do jednej z tych grup, sprawdza się, czy ma korzenie i tkanki przewodzące, czy rozmnaża się przez zarodniki czy nasiona, jak zbudowane są jej liście oraz czy wytwarza kwiaty i owoce.

ZNACZENIE ROŚLIN DLA CZŁOWIEKA
Rośliny są podstawą wyżywienia ludzi i zwierząt hodowlanych — dostarczają zbóż, roślin okopowych, strączkowych i oleistych, warzyw oraz owoców. Dają drewno wykorzystywane w budownictwie i do produkcji papieru, włókna do wyrobu tkanin (len, bawełna), paliwa i surowce do biopaliw, a także substancje lecznicze — z naparstnicy otrzymuje się leki nasercowe, a kwas acetylosalicylowy wywodzi się ze związku obecnego w korze wierzby. Są źródłem przypraw, barwników, kauczuku i żywic. Lasy wytwarzają tlen, pochłaniają dwutlenek węgla i zanieczyszczenia powietrza, chronią glebę przed erozją i regulują obieg wody, a torfowiska magazynują ogromne ilości węgla. Rośliny ozdobne i zieleń miejska poprawiają warunki i jakość życia ludzi.
''',
        flashcards: [
          Flashcard(id: 'f_k2_ros_78', front: 'Podaj po jednym rodzimym przedstawicielu mchów, widłakowych, skrzypowych i paprociowych.', back: 'Płonnik pospolity, widłak goździsty, skrzyp polny, nerecznica samcza.'),
          Flashcard(id: 'f_k2_ros_79', front: 'Wymień rodzime gatunki roślin nagonasiennych.', back: 'Sosna zwyczajna, jodła pospolita, modrzew europejski, jałowiec pospolity.'),
          Flashcard(id: 'f_k2_ros_80', front: 'Na podstawie jakich cech zalicza się roślinę do mchów, paprotników lub roślin nasiennych?', back: 'Obecności korzeni i tkanek przewodzących, rozmnażania przez zarodniki lub nasiona, budowy liści oraz obecności kwiatów i owoców.'),
          Flashcard(id: 'f_k2_ros_81', front: 'Podaj przykłady znaczenia roślin dla człowieka.', back: 'Pożywienie, drewno i papier, włókna (len, bawełna), leki (np. z naparstnicy), paliwa, tlen i ochrona gleby przed erozją.'),
...
Merystemy zbudowane są z komórek zdolnych do podziałów, o cienkich ścianach, dużym jądrze i niewielkich wakuolach. Merystemy wierzchołkowe leżą w stożkach wzrostu pędu i korzenia i odpowiadają za wzrost na długość. Merystemy boczne — kambium (miazga) oraz fellogen (miazga korkotwórcza) — odpowiadają za przyrost na grubość. Kambium odkłada do wewnątrz drewno wtórne, a na zewnątrz łyko wtórne; fellogen wytwarza korek.

TKANKI OKRYWAJĄCE
Skórka (epiderma) okrywa młode organy. Tworzy ją zwykle jedna warstwa ściśle przylegających komórek pokrytych kutykulą. W skórce znajdują się aparaty szparkowe zbudowane z dwóch komórek przyszparkowych otaczających szparkę, a także włoski — chroniące, wydzielnicze lub czepne. Włośniki to wydłużone komórki skórki korzenia zwiększające powierzchnię chłonną. Korek, wchodzący w skład perydermy, zastępuje skórkę w organach starszych; jego ściany wysycone są suberyną, co czyni go nieprzepuszczalnym, a wymianę gazową umożliwiają przetchlinki.
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_ros_18', question: 'Aparat szparkowy tworzą:', options: ['Wydłużone komórki skórki korzenia zwane włośnikami', 'Dwie komórki przyszparkowe otaczające szparkę', 'Martwe komórki kamienne o zdrewniałych ścianach', 'Rurki sitowe wraz z komórkami towarzyszącymi'], correctIndex: 1, explanation: 'Komórki przyszparkowe, zmieniając turgor, otwierają i zamykają szparkę.'),
          ...
          QuizQuestion(id: 'q_k2_ros_20', question: 'Plazmodesmy umożliwiają:', options: ['Wymianę gazową między liściem a atmosferą', 'Bezpośredni przepływ substancji między sąsiednimi komórkami', 'Usztywnienie ściany komórkowej dzięki odkładaniu ligniny', 'Magazynowanie wody w dużej centralnej wakuoli'], correctIndex: 1, explanation: 'To kanały cytoplazmatyczne tworzące symplast.'),
...
ŁODYGA
Łodyga podtrzymuje liście, kwiaty i owoce oraz przewodzi substancje między korzeniem a liśćmi. Wyrastają z niej liście w węzłach, a odcinki między nimi to międzywęźla.

BUDOWA PIERWOTNA ŁODYGI
W budowie pierwotnej łodygę okrywa skórka z kutykulą, pod którą leży kora pierwotna, często z kolenchymą tuż pod skórką, a wnętrze zajmuje walec osiowy z wiązkami przewodzącymi. W wiązkach łodygi łyko leży od strony zewnętrznej, a drewno — od strony środka. U roślin dwuliściennych wiązki przewodzące są otwarte, czyli między łykiem a drewnem leży miazga (kambium), i ułożone są w pierścień, a środek łodygi wypełnia miękisz rdzeniowy. U roślin jednoliściennych wiązki są zamknięte, czyli pozbawione kambium, i rozproszone w całym przekroju łodygi, a granica między korą pierwotną a walcem osiowym jest niewyraźna. Brak kambium sprawia, że łodygi większości roślin jednoliściennych nie przyrastają wtórnie na grubość.

BUDOWA WTÓRNA ŁODYGI
U roślin nagonasiennych i drzewiastych roślin dwuliściennych kambium wiązkowe łączy się z kambium powstającym między wiązkami w zamknięty pierścień. Kambium odkłada do wewnątrz drewno wtórne, a na zewnątrz łyko wtórne, dzięki czemu łodyga przyrasta na grubość; drewna powstaje znacznie więcej niż łyka. Rosnąca łodyga rozrywa skórkę, dlatego zastępuje ją peryderma: miazga korkotwórcza (fellogen) wytwarza na zewnątrz korek, a do wewnątrz fellodermę. Wymianę gazową przez nieprzepuszczalny korek umożliwiają przetchlinki. Co roku kambium odkłada drewno wiosenne o szerokich naczyniach i cienkich ścianach oraz drewno letnie o wąskich naczyniach i grubszych ścianach — powstają słoje roczne, dzięki którym można określić wiek drzewa i warunki panujące w kolejnych latach. Zewnętrzne, młodsze warstwy drewna przewodzą wodę i tworzą biel, a starsze, wewnętrzne warstwy przestają ją przewodzić i tworzą twardziel.
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_ros_94', front: 'Jak rozmieszczone są wiązki przewodzące w łodydze jedno- i dwuliściennych?', back: 'U dwuliściennych — w pierścieniu wokół rdzenia, u jednoliściennych — rozproszone w całym przekroju.'),
          Flashcard(id: 'f_k2_ros_95', front: 'Czym różni się wiązka przewodząca otwarta od zamkniętej?', back: 'Otwarta ma kambium między łykiem a drewnem (dwuliścienne), zamknięta go nie ma (jednoliścienne).'),
          Flashcard(id: 'f_k2_ros_96', front: 'Dlaczego łodygi roślin jednoliściennych nie przyrastają wtórnie na grubość?', back: 'Ich wiązki przewodzące są zamknięte — nie mają kambium.'),
          Flashcard(id: 'f_k2_ros_97', front: 'Co odkłada kambium podczas przyrostu wtórnego łodygi?', back: 'Do wewnątrz drewno wtórne, na zewnątrz łyko wtórne.'),
          Flashcard(id: 'f_k2_ros_98', front: 'Z czego składa się peryderma?', back: 'Z fellogenu, wytwarzanego przez niego na zewnątrz korka i do wewnątrz fellodermy.'),
          Flashcard(id: 'f_k2_ros_99', front: 'Czym różni się biel od twardzieli?', back: 'Biel to młodsze, zewnętrzne warstwy drewna przewodzące wodę, twardziel — starsze, wewnętrzne, nieprzewodzące.'),
        ],
        questions: [
          QuizQuestion(id: 'q_k2_ros_101', question: 'Wiązki przewodzące rozproszone w całym przekroju łodygi są typowe dla:', options: ['Roślin dwuliściennych', 'Roślin jednoliściennych', 'Nagonasiennych', 'Drzew liściastych'], correctIndex: 1, explanation: 'U dwuliściennych wiązki tworzą pierścień wokół rdzenia.'),
          QuizQuestion(id: 'q_k2_ros_102', question: 'Kambium w wiązce przewodzącej łodygi rośliny dwuliściennej leży:', options: ['W środku miękiszu rdzeniowego', 'Między łykiem a drewnem', 'Tuż pod skórką łodygi', 'W zewnętrznej warstwie kory'], correctIndex: 1, explanation: 'Taka wiązka nazywana jest otwartą.'),
          QuizQuestion(id: 'q_k2_ros_103', question: 'Korek powstaje w wyniku działalności:', options: ['Kambium', 'Fellogenu', 'Merystemu wierzchołkowego', 'Kolenchymy'], correctIndex: 1, explanation: 'Fellogen wytwarza korek na zewnątrz i fellodermę do wewnątrz.'),
          QuizQuestion(id: 'q_k2_ros_104', question: 'Przyrost wtórny łodygi na grubość jest wynikiem działalności:', options: ['Merystemu wierzchołkowego', 'Kambium', 'Miękiszu rdzeniowego', 'Skórki'], correctIndex: 1, explanation: 'Kambium odkłada drewno wtórne i łyko wtórne.'),
...
DOŚWIADCZENIE — TKANKA PRZEWODZĄCA WODĘ
Pęd rośliny, np. selera naciowego lub białego goździka, umieszcza się w wodzie zabarwionej atramentem lub barwnikiem spożywczym, a próbę kontrolną stanowi taki sam pęd w czystej wodzie. Po kilku godzinach wykonuje się poprzeczne przekroje łodygi i ogląda je pod mikroskopem lub lupą. Zabarwione są tylko wiązki przewodzące, a w nich — drewno, co dowodzi, że woda transportowana jest w górę rośliny naczyniami i cewkami drewna. Barwnik dociera też do nerwów liści, a u białego kwiatu zabarwiają się płatki.

DOŚWIADCZENIE — TRANSPIRACJA I CZYNNIKI JĄ WARUNKUJĄCE
Wydzielanie wody przez liście można wykazać, zakładając na ulistniony pęd rośliny doniczkowej przezroczysty foliowy worek; po kilku godzinach na jego wewnętrznej powierzchni pojawiają się krople wody. Glebę w doniczce przykrywa się folią, by woda nie parowała z podłoża. Intensywność transpiracji mierzy się, umieszczając jednakowe pędy w cylindrach miarowych z wodą, której powierzchnię pokrywa warstwa oleju zapobiegająca parowaniu, i odczytując ubytek wody po określonym czasie. Jeden zestaw pozostawia się w warunkach kontrolnych, a w pozostałych zmienia się tylko jeden czynnik — np. ustawia się pęd przed wentylatorem, w miejscu nasłonecznionym lub przykrywa worek, zwiększając wilgotność powietrza. Większy ubytek wody przy wietrze, w wyższej temperaturze i przy silnym świetle oraz mniejszy przy wysokiej wilgotności potwierdzają wpływ tych czynników na transpirację. Zestaw z pędem pozbawionym liści wykazuje, że woda paruje głównie przez liście.
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_ros_100', front: 'Jak wykazać, którą tkanką transportowana jest woda w łodydze?', back: 'Wstawić pęd do zabarwionej wody i obejrzeć przekrój poprzeczny — zabarwia się drewno wiązek przewodzących.'),
          Flashcard(id: 'f_k2_ros_101', front: 'Jak wykazać, że liście wydzielają wodę?', back: 'Założyć na ulistniony pęd przezroczysty worek (przy przykrytej glebie) — na jego ściankach pojawiają się krople.'),
          Flashcard(id: 'f_k2_ros_102', front: 'Po co w doświadczeniu z transpiracją pokrywa się wodę w cylindrze warstwą oleju?', back: 'Aby woda nie parowała z powierzchni cylindra i ubytek wynikał tylko z transpiracji.'),
          Flashcard(id: 'f_k2_ros_103', front: 'Jak zbadać wpływ wiatru na transpirację?', back: 'Porównać ubytek wody z cylindra z pędem przed wentylatorem i w warunkach kontrolnych.'),
        ],
        questions: [
          QuizQuestion(id: 'q_k2_ros_105', question: 'Po wstawieniu pędu selera do wody z atramentem na przekroju łodygi zabarwi się:', options: ['Miękisz rdzeniowy łodygi', 'Drewno wiązek przewodzących', 'Łyko wiązek przewodzących', 'Kolenchyma pod skórką'], correctIndex: 1, explanation: 'Woda transportowana jest w górę naczyniami i cewkami drewna.'),
          QuizQuestion(id: 'q_k2_ros_106', question: 'W doświadczeniu badającym wpływ wiatru na transpirację próbą kontrolną jest pęd:', options: ['Ustawiony przed wentylatorem', 'W identycznych warunkach, ale bez wentylatora', 'Pozbawiony liści i ustawiony przed wentylatorem', 'Umieszczony w ciemności przed wentylatorem'], correctIndex: 1, explanation: 'Próba kontrolna różni się tylko badanym czynnikiem.'),
          QuizQuestion(id: 'q_k2_ros_107', question: 'Nasiona fasoli na suchej ligninie nie kiełkują. Świadczy to, że do kiełkowania niezbędna jest:', options: ['Gleba', 'Woda', 'Światło', 'Nawóz'], correctIndex: 1, explanation: 'Woda umożliwia pęcznienie nasion i uruchomienie przemian metabolicznych.'),
          QuizQuestion(id: 'q_k2_ros_108', question: 'Siewki fasoli pozbawione liścieni rosną najsłabiej, ponieważ:', options: ['Nie mogą pobierać wody', 'Brakuje im substancji zapasowych', 'Nie mają korzeni', 'Nie mają chlorofilu'], correctIndex: 1, explanation: 'Liścienie dostarczają energii i budulca do czasu rozpoczęcia fotosyntezy.'),
          ...
          QuizQuestion(id: 'q_k2_ros_32', question: 'Otwarcie aparatu szparkowego następuje, gdy komórki przyszparkowe:', options: ['Tracą jony K+, wodę i zmniejszają turgor', 'Pobierają jony K+, wodę i zwiększają turgor', 'Obumierają i tracą zawartość cytoplazmy', 'Tracą chloroplasty i przestają oddychać'], correctIndex: 1, explanation: 'Wzrost turgoru wygina nierównomiernie zgrubiałe ściany i otwiera szparkę.'),
...
DOŚWIADCZENIE BADAJĄCE WPŁYW TEMPERATURY NA FOTOSYNTEZĘ
Jednakowe pędy moczarki kanadyjskiej umieszcza się w kilku zlewkach z wodą z dodatkiem wodorowęglanu sodu o różnej temperaturze, np. 10°C, 20°C, 30°C i 45°C, utrzymywanej w łaźni wodnej. Wszystkie zestawy oświetla się lampą z tej samej odległości i po kilku minutach aklimatyzacji liczy się pęcherzyki tlenu wydzielane w jednostce czasu. Liczba pęcherzyków rośnie wraz ze wzrostem temperatury do około 25–30°C, a w wyższej temperaturze gwałtownie spada. Świadczy to o tym, że temperatura wpływa na aktywność enzymów fotosyntezy: do optimum ją zwiększa, a powyżej optimum enzymy ulegają denaturacji. Próbą kontrolną jest zestaw w temperaturze pokojowej, a zmiennym czynnikiem — wyłącznie temperatura wody.
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_ros_104', front: 'Jak zbadać wpływ temperatury na intensywność fotosyntezy?', back: 'Liczyć pęcherzyki tlenu wydzielane przez moczarkę w wodzie o różnej temperaturze, przy tym samym oświetleniu i stężeniu wodorowęglanu.'),
          Flashcard(id: 'f_k2_ros_105', front: 'Jaki wynik daje doświadczenie z wpływem temperatury na fotosyntezę?', back: 'Liczba pęcherzyków rośnie do optimum (ok. 25–30°C), a powyżej gwałtownie spada.'),
        ],
        questions: [
          QuizQuestion(id: 'q_k2_ros_109', question: 'W doświadczeniu badającym wpływ temperatury na fotosyntezę moczarki zmiennym czynnikiem jest:', options: ['Odległość od lampy', 'Temperatura wody', 'Stężenie wodorowęglanu sodu', 'Gatunek rośliny'], correctIndex: 1, explanation: 'Pozostałe warunki muszą być jednakowe we wszystkich zestawach.'),
...
PRZEMIANA POKOLEŃ W POSZCZEGÓLNYCH GRUPACH ROŚLIN
U mchów z zarodnika wyrasta splątek, a z niego zielona roślinka — gametofit, na którym powstają plemnie (męskie organy płciowe) i rodnie (żeńskie). Po zapłodnieniu, które wymaga obecności wody, z zygoty w rodni rozwija się sporofit — seta z zarodnią — który pozostaje trwale związany z gametofitem i jest od niego zależny. W zarodni w wyniku mejozy powstają zarodniki.
U widłakowych, skrzypowych i paprociowych dominuje samodzielny sporofit z korzeniami, łodygą i liśćmi. Zarodniki powstają w zarodniach — u widłaków i skrzypów zebranych w kłosy zarodnionośne, a u paproci w kupkach na spodniej stronie liści. Z zarodnika rozwija się niewielki, samożywny gametofit, czyli przedrośle, na którym powstają plemnie i rodnie. Plemniki docierają do komórek jajowych w wodzie, a z zygoty wyrasta nowy sporofit, początkowo odżywiany przez przedrośle, które następnie obumiera.
U nagonasiennych, np. sosny, sporofitem jest drzewo, które wytwarza kwiaty męskie, zebrane w kwiatostany, z łuskami, na których powstają ziarna pyłku, oraz kwiaty żeńskie, zebrane w szyszki, z łuskami nasiennymi, na których leżą odsłonięte zalążki. Gametofity są silnie zredukowane i rozwijają się na sporoficie: ziarno pyłku jest gametofitem męskim, a gametofit żeński powstaje wewnątrz zalążka. Pyłek przenoszony jest przez wiatr, a komórki plemnikowe docierają do komórki jajowej łagiewką pyłkową, więc do zapłodnienia nie jest potrzebna woda. Z zygoty rozwija się zarodek, tkanką odżywczą nasienia jest haploidalne bielmo pierwotne, będące pozostałością gametofitu żeńskiego, a z zalążka powstaje nasienie. U sosny od zapylenia do dojrzenia nasion mijają około dwa lata.
U okrytonasiennych gametofity są zredukowane najbardziej. Gametofitem męskim jest kiełkujące ziarno pyłku, zawierające komórkę wegetatywną i dwie komórki plemnikowe, a gametofitem żeńskim — woreczek zalążkowy w zalążku, w którym znajdują się m.in. komórka jajowa i komórka centralna. Po podwójnym zapłodnieniu z zalążka powstaje nasienie z triploidalnym bielmem wtórnym, a z zalążni — owoc.
''',
        flashcards: [
          Flashcard(id: 'f_k2_ros_82', front: 'Jak przebiega przemiana pokoleń u mchów?', back: 'Gametofit (zielona roślinka) wytwarza plemnie i rodnie; po zapłodnieniu w wodzie wyrasta na nim zależny sporofit z zarodnią, w której w mejozie powstają zarodniki.'),
          Flashcard(id: 'f_k2_ros_83', front: 'Czym jest przedrośle i u których roślin występuje?', back: 'Samożywnym gametofitem z plemniami i rodniami — występuje u paprociowych, skrzypowych i widłakowych.'),
          Flashcard(id: 'f_k2_ros_84', front: 'Gdzie powstają zarodniki u paproci, a gdzie u skrzypów?', back: 'U paproci w kupkach zarodni na spodniej stronie liści, u skrzypów — w kłosach zarodnionośnych.'),
          Flashcard(id: 'f_k2_ros_85', front: 'Co jest gametofitem męskim, a co żeńskim u sosny?', back: 'Męskim — ziarno pyłku, żeńskim — tkanka rozwijająca się wewnątrz zalążka.'),
          Flashcard(id: 'f_k2_ros_86', front: 'Jaką ploidalność ma bielmo nagonasiennych, a jaką okrytonasiennych?', back: 'U nagonasiennych haploidalną (bielmo pierwotne), u okrytonasiennych triploidalną (bielmo wtórne).'),
          Flashcard(id: 'f_k2_ros_87', front: 'Co jest gametofitem żeńskim u roślin okrytonasiennych?', back: 'Woreczek zalążkowy w zalążku.'),
          Flashcard(id: 'f_k2_ros_88', front: 'Jak zmieniał się gametofit w kolejnych grupach roślin lądowych?', back: 'Od dominującego u mchów, przez samodzielne przedrośle paprotników, do silnie zredukowanego i zależnego od sporofitu u roślin nasiennych.'),
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_ros_53', question: 'Łagiewka pyłkowa służy do:', options: ['Wychwytywania ziaren pyłku z powietrza', 'Doprowadzenia komórek plemnikowych do zalążka', 'Odżywiania rozwijającego się zarodka', 'Rozsiewania dojrzałych nasion przez wiatr'], correctIndex: 1, explanation: 'Wyrasta z ziarna pyłku i transportuje komórki plemnikowe.'),
        ],
      ),
      Topic(
...
NASTIE
Nastie to ruchy niezależne od kierunku działania bodźca — reakcja jest zawsze taka sama, niezależnie od tego, z której strony bodziec działa. Nyktynastie to ruchy związane ze zmianą pory dnia, na przykład zamykanie się na noc koszyczków mniszka lekarskiego czy składanie liści szczawika zajęczego. Sejsmonastie to reakcja na wstrząs lub dotyk — najbardziej znanym przykładem jest mimoza wstydliwa, która składa listki po dotknięciu. Termonastie zachodzą pod wpływem zmian temperatury — tak otwierają się w cieple i zamykają w chłodzie kwiaty tulipana i krokusa.
...
DOŚWIADCZENIE — WPŁYW WODY, TEMPERATURY I ŚWIATŁA NA KIEŁKOWANIE
Jednakową liczbę nasion tego samego gatunku, np. fasoli lub rzeżuchy, umieszcza się na ligninie w kilku zestawach. W zestawie kontrolnym lignina jest wilgotna, a nasiona mają temperaturę pokojową i dostęp do światła. W zestawach badawczych zmienia się tylko jeden czynnik: w pierwszym lignina jest sucha, drugi zestaw umieszcza się w lodówce, a trzeci w ciemności. Po kilku dniach liczy się skiełkowane nasiona w każdym zestawie. Nasiona na suchej ligninie i w lodówce nie kiełkują, co dowodzi, że do kiełkowania niezbędne są woda i odpowiednia temperatura. Wynik zestawu umieszczonego w ciemności pokazuje, czy nasiona danego gatunku wymagają światła — nasiona fasoli i rzeżuchy kiełkują także w ciemności. Aby wynik był wiarygodny, w każdym zestawie trzeba użyć odpowiednio dużej liczby nasion.

DOŚWIADCZENIE — ROLA LIŚCIENI WE WZROŚCIE I ROZWOJU SIEWKI
Z kilku jednakowych, napęczniałych nasion fasoli lub grochu usuwa się oba liścienie, z kilku kolejnych — jeden, a pozostałe nasiona pozostawia się nienaruszone jako próbę kontrolną. Wszystkie hoduje się w jednakowych warunkach — przy tym samym dostępie do wody i światła i w tej samej temperaturze. Po kilkunastu dniach porównuje się wysokość i masę siewek oraz liczbę i wielkość liści. Siewki pozbawione obu liścieni rosną najsłabiej lub obumierają, a siewki z jednym liścieniem rosną słabiej niż kontrolne. Świadczy to o tym, że substancje zapasowe zgromadzone w liścieniach zapewniają siewce energię i materiał budulcowy do wzrostu, zanim zacznie ona samodzielnie prowadzić fotosyntezę.
''',
        flashcards: [
          Flashcard(id: 'f_k2_ros_89', front: 'Jak zbadać wpływ wody na kiełkowanie nasion?', back: 'Porównać nasiona na wilgotnej ligninie (kontrola) z nasionami na suchej ligninie, przy tych samych pozostałych warunkach.'),
          Flashcard(id: 'f_k2_ros_90', front: 'Który zestaw jest próbą kontrolną w doświadczeniu nad kiełkowaniem?', back: 'Nasiona z dostępem do wody i światła, w temperaturze pokojowej.'),
          Flashcard(id: 'f_k2_ros_91', front: 'Jak wykazać rolę liścieni we wzroście siewki?', back: 'Porównać wzrost siewek z usuniętymi oboma liścieniami, z jednym liścieniem i nienaruszonych (kontrola).'),
          Flashcard(id: 'f_k2_ros_92', front: 'Jaki wynik doświadczenia potwierdza rolę liścieni?', back: 'Siewki bez liścieni rosną najsłabiej — liścienie dostarczają substancji zapasowych.'),
          Flashcard(id: 'f_k2_ros_93', front: 'Dlaczego w doświadczeniu zmienia się tylko jeden czynnik?', back: 'Aby mieć pewność, że różnica w wynikach wynika właśnie z tego czynnika.'),
...
DRZEWO FILOGENETYCZNE ZWIERZĄT
Współczesne drzewo rodowe zwierząt powstało na podstawie porównywania sekwencji DNA i białek oraz cech rozwoju zarodkowego i budowy. Wcześnie oddzieliła się linia parzydełkowców — zwierząt dwuwarstwowych o symetrii promienistej. Pozostałe grupy tworzą zwierzęta dwubocznie symetryczne, które dzielą się na dwie wielkie linie ewolucyjne, różniące się rozwojem zarodkowym. U zwierząt pierwoustych z pragęby, czyli pierwszego otworu powstającego w zarodku, rozwija się otwór gębowy, a u wtóroustych pragęba przekształca się w odbyt, a otwór gębowy powstaje później. Zwierzęta pierwouste obejmują dwie grupy: lofotrochorowce, do których należą płazińce, pierścienice i mięczaki, oraz wylinkowce, do których należą nicienie i stawonogi — zwierzęta linieją, zrzucając oskórek. Do zwierząt wtóroustych należą szkarłupnie i strunowce, a wśród strunowców — kręgowce. Wynika z tego, że szkarłupnie są bliżej spokrewnione z kręgowcami niż z pozostałymi bezkręgowcami, a nicienie — bliżej ze stawonogami niż z płazińcami, choć podobieństwo budowy mogłoby sugerować co innego. Na drzewie kręgowców kolejno oddzielają się ryby, płazy i owodniowce, wśród których jedna linia prowadzi do ssaków, a druga do gadów i ptaków; ptaki są najbliżej spokrewnione z krokodylami. Drzewo filogenetyczne odczytuje się tak samo jak kladogram — o pokrewieństwie świadczy bliskość wspólnego rozgałęzienia.
''',
        flashcards: [
          Flashcard(id: 'f_k2_zw_filo_1', front: 'Czym różnią się zwierzęta pierwouste od wtóroustych?', back: 'U pierwoustych z pragęby powstaje otwór gębowy, a u wtóroustych — odbyt; otwór gębowy powstaje u nich później.'),
          Flashcard(id: 'f_k2_zw_filo_2', front: 'Które grupy zwierząt należą do wtóroustych?', back: 'Szkarłupnie i strunowce (w tym kręgowce).'),
          Flashcard(id: 'f_k2_zw_filo_3', front: 'Które grupy zwierząt należą do wylinkowców, a które do lofotrochorowców?', back: 'Wylinkowce: nicienie i stawonogi. Lofotrochorowce: płazińce, pierścienice i mięczaki.'),
          Flashcard(id: 'f_k2_zw_filo_4', front: 'Z jaką grupą gadów ptaki są najbliżej spokrewnione?', back: 'Z krokodylami.'),
          Flashcard(id: 'f_k2_zw_filo_5', front: 'Na jakiej podstawie tworzy się współczesne drzewo filogenetyczne zwierząt?', back: 'Na podstawie porównania sekwencji DNA i białek oraz cech rozwoju zarodkowego i budowy.'),
        ...
        questions: [
          QuizQuestion(id: 'q_k2_zw_filo_1', question: 'Do zwierząt wtóroustych należą:', options: ['Stawonogi', 'Szkarłupnie', 'Mięczaki', 'Nicienie'], correctIndex: 1, explanation: 'Zwierzęta wtórouste to szkarłupnie i strunowce.'),
          QuizQuestion(id: 'q_k2_zw_filo_2', question: 'Według drzewa filogenetycznego nicienie są najbliżej spokrewnione ze:', options: ['Stawonogami', 'Szkarłupniami', 'Strunowcami', 'Parzydełkowcami'], correctIndex: 0, explanation: 'Obie grupy należą do wylinkowców — linieją, zrzucając oskórek.'),
          QuizQuestion(id: 'q_k2_zw_filo_3', question: 'U zwierząt pierwoustych z pragęby rozwija się:', options: ['Odbyt', 'Otwór gębowy', 'Celoma', 'Struna grzbietowa'], correctIndex: 1, explanation: 'U zwierząt wtóroustych pragęba przekształca się w odbyt.'),
          ...
          QuizQuestion(id: 'q_k2_zw_7', question: 'Celoma to jama ciała:', options: ['Nieobecna u pierścienic i głowonogów', 'Wysłana nabłonkiem pochodzenia mezodermalnego', 'Wypełniona tkanką, typowa dla płazińców', 'Wypełniona powietrzem, służąca do oddychania'], correctIndex: 1, explanation: 'Wtórna jama ciała wysłana nabłonkiem mezodermalnym występuje m.in. u pierścienic.'),
...
NICIENIE
Mają obłe, niesegmentowane ciało pokryte oskórkiem i pierwotną jamę ciała. W odróżnieniu od parzydełkowców i płazińców mają przewód pokarmowy z dwoma otworami — gębowym i odbytowym — co umożliwia jednokierunkowy przepływ pokarmu i jego stopniowe trawienie. Są zwykle rozdzielnopłciowe, a samice bywają większe od samców. Do pasożytów człowieka należą glista ludzka, owsik i włosień kręty.
...
''',
        flashcards: [
          ...
          Flashcard(id: 'f_k2_zw_14', front: 'Jakie znaczenie ma przewód pokarmowy z dwoma otworami, występujący np. u nicieni?', back: 'Umożliwia jednokierunkowy przepływ pokarmu i jego stopniowe trawienie.'),
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_zw_10', question: 'Tasiemiec nie ma układu pokarmowego, ponieważ:', options: ['Nie odżywia się wcale przez cały okres życia', 'Wchłania strawiony pokarm gospodarza całą powierzchnią ciała', 'Trawi pokarm zewnątrzustrojowo, jak pająki', 'Odżywia się samożywnie dzięki symbiotycznym glonom w ciele'], correctIndex: 1, explanation: 'To przystosowanie do pasożytnictwa w jelicie żywiciela.'),
          QuizQuestion(id: 'q_k2_zw_11', question: 'Przewód pokarmowy z otworem gębowym i odbytowym mają:', options: ['Parzydełkowce', 'Płazińce wolno żyjące', 'Nicienie', 'Tasiemce'], correctIndex: 2, explanation: 'Parzydełkowce i płazińce wolno żyjące mają przewód pokarmowy z jednym otworem, a tasiemce nie mają go wcale.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_zw_20', question: 'Sucha skóra pokryta rogowymi łuskami, uboga w gruczoły, jest cechą:', options: ['Płazów', 'Gadów', 'Ryb', 'Ssaków'], correctIndex: 1, explanation: 'Ogranicza to utratę wody i umożliwia życie z dala od zbiorników.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_wir_3', question: 'W cyklu lizogenicznym materiał genetyczny wirusa:', options: ['Natychmiast niszczy komórkę i uwalnia nowe cząstki', 'Zostaje wbudowany w genom gospodarza i jest z nim powielany', 'Pozostaje poza komórką, w kapsydzie przyczepionym do ściany', 'Ulega rozkładowi przez enzymy restrykcyjne bakterii'], correctIndex: 1, explanation: 'Jako profag może trwać w utajeniu przez wiele pokoleń komórek.'),
          ...
          QuizQuestion(id: 'q_k2_wir_7', question: 'Specyficzność wirusa wobec określonych komórek wynika z:', options: ['Wielkości cząstki wirusa w stosunku do komórki', 'Dopasowania białek powierzchniowych do receptorów komórki', 'Rodzaju kwasu nukleinowego zawartego w kapsydzie', 'Temperatury otoczenia w chwili zakażenia komórki'], correctIndex: 1, explanation: 'Białka wirusa muszą pasować do receptorów komórki jak klucz do zamka.'),
...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_wir_12', question: 'Wścieklizna przenosi się najczęściej przez:', options: ['Drogę kropelkową, przy kaszlu chorego', 'Ślinę chorego zwierzęcia, przy ugryzieniu', 'Zanieczyszczoną wodę, przy jej piciu', 'Kontakty płciowe, bez zabezpieczenia'], correctIndex: 1, explanation: 'Wirus obecny jest w ślinie zakażonego zwierzęcia.'),
          QuizQuestion(id: 'q_k2_wir_13', question: 'Antybiotyki są nieskuteczne wobec wirusów, ponieważ:', options: ['Wirusy są zbyt małe, by antybiotyk mógł do nich dotrzeć', 'Wirusy nie mają struktur komórkowych, na które działają antybiotyki', 'Wirusy namnażają się wyłącznie w glebie, poza organizmem', 'Antybiotyki nie przenikają z przewodu pokarmowego do krwi'], correctIndex: 1, explanation: 'Antybiotyki celują w ścianę komórkową, rybosomy czy metabolizm bakterii.'),
