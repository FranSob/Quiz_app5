...
''',
        ...
        questions: [
          ...
          QuizQuestion(id: 'q_k2_ros_102', question: 'Kambium w wiązce przewodzącej łodygi rośliny dwuliściennej leży:', options: ['W rdzeniu', 'Między łykiem a drewnem', 'Pod skórką', 'W endodermie'], correctIndex: 1, explanation: 'Taka wiązka nazywana jest otwartą.'),
...
''',
        ...
        questions: [
          QuizQuestion(id: 'q_k2_ros_105', question: 'Po wstawieniu pędu selera do wody z atramentem na przekroju łodygi zabarwi się:', options: ['Rdzeń', 'Drewno wiązek przewodzących', 'Skórka', 'Kora pierwotna'], correctIndex: 1, explanation: 'Woda transportowana jest w górę naczyniami i cewkami drewna.'),
...
Współczesne drzewo rodowe zwierząt powstało na podstawie porównywania sekwencji DNA i białek oraz cech rozwoju zarodkowego i budowy. Wcześnie oddzieliła się linia parzydełkowców — zwierząt dwuwarstwowych o symetrii promienistej. Pozostałe grupy tworzą zwierzęta dwubocznie symetryczne, które dzielą się na dwie wielkie linie ewolucyjne, różniące się rozwojem zarodkowym. U pierwouśćców z pragęby, czyli pierwszego otworu powstającego w zarodku, rozwija się otwór gębowy, a u wtórouśćców pragęba przekształca się w odbyt, a otwór gębowy powstaje później. Pierwouśćce obejmują dwie grupy: lofotrochorowce, do których należą płazińce, pierścienice i mięczaki, oraz wylinkowce, do których należą nicienie i stawonogi — zwierzęta linieją, zrzucając oskórek. Do wtórouśćców należą szkarłupnie i strunowce, a wśród strunowców — kręgowce. Wynika z tego, że szkarłupnie są bliżej spokrewnione z kręgowcami niż z pozostałymi bezkręgowcami, a nicienie — bliżej ze stawonogami niż z płazińcami, choć podobieństwo budowy mogłoby sugerować co innego. Na drzewie kręgowców kolejno oddzielają się ryby, płazy i owodniowce, wśród których jedna linia prowadzi do ssaków, a druga do gadów i ptaków; ptaki są najbliżej spokrewnione z krokodylami. Drzewo filogenetyczne odczytuje się tak samo jak kladogram — o pokrewieństwie świadczy bliskość wspólnego rozgałęzienia.
''',
        flashcards: [
          Flashcard(id: 'f_k2_zw_filo_1', front: 'Czym różnią się pierwouśćce od wtórouśćców?', back: 'U pierwouśćców z pragęby powstaje otwór gębowy, u wtórouśćców — odbyt, a otwór gębowy powstaje później.'),
          Flashcard(id: 'f_k2_zw_filo_2', front: 'Które grupy zwierząt należą do wtórouśćców?', back: 'Szkarłupnie i strunowce (w tym kręgowce).'),
        ...
        questions: [
          QuizQuestion(id: 'q_k2_zw_filo_1', question: 'Do wtórouśćców należą:', options: ['Stawonogi', 'Szkarłupnie', 'Mięczaki', 'Nicienie'], correctIndex: 1, explanation: 'Wtórouśćce to szkarłupnie i strunowce.'),
          ...
          QuizQuestion(id: 'q_k2_zw_filo_3', question: 'U pierwouśćców z pragęby rozwija się:', options: ['Odbyt', 'Otwór gębowy', 'Celoma', 'Struna grzbietowa'], correctIndex: 1, explanation: 'U wtórouśćców pragęba przekształca się w odbyt.'),
